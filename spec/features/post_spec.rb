...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "non@authorized.com", password: "nonauthorized", password_confirmation: "nonauthorized", phone: "5555555555")
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'More Rationale', user_id: delete_user.id, overtime_request: 3.5)
